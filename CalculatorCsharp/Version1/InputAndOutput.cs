namespace CalculatorCsharpV1 {
    ...
    public record struct Input() {
        ...
        public static int GetIntValue() {
            Console.WriteLine("Input integer value number/N");
            string value = Console.ReadLine();

            while (!int.TryParse(value, out _)) {
                if (!value.Equals("N", StringComparison.CurrentCultureIgnoreCase)) {
        ...
        public static int GetIntValue(string msg) {
            Console.WriteLine(msg + " number/N");
            string value = Console.ReadLine();
        ...
        public static float GetFloatValue() {
            Console.WriteLine("Input float value number/N");
            string value = Console.ReadLine();
        ...
        public static double GetDoubleValue() {
            Console.WriteLine("Input double value number/N");
            string value = Console.ReadLine();
        ...
        public static decimal GetDecimalValue() {
            Console.WriteLine("Input decimal value number/N");
            string value = Console.ReadLine();
